...
export default function UpdateDefence() {
  ...
  useEffect(() => {
    axios
      .get(`${import.meta.env.VITE_BACKEND_URL}/api/defence`)
      .then((res) => setFormData(Array.isArray(res.data) ? res.data : []))
      .catch((err) => console.error('Failed to load defence articles', err));
  }, []);
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    axios
      .post(`${import.meta.env.VITE_BACKEND_URL}/api/defence`, formData)
      .then(() => alert('✅ Defence articles updated'))
      .catch((err) => {
        console.error('Submit Error:', err);
        alert('❌ Failed to update defence articles');
      });
  };

  return (
    <div className="max-w-6xl mx-auto p-6">
      <h1 className="text-3xl font-bold text-center mb-6">🛡️ Update Defence Articles</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="e.g. Army, Navy, Airforce"
                />
              </div>
