...
export default function UpdateScienceNews() {
  ...
  useEffect(() => {
    axios
      .get(`${import.meta.env.VITE_BACKEND_URL}/api/science-news`)
      .then((res) => setFormData(Array.isArray(res.data) ? res.data : []))
      .catch((err) => console.error('Failed to load Science news', err));
  }, []);
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post(`${import.meta.env.VITE_BACKEND_URL}/api/science-news`, cleanedData)
      .then(() => alert('✅ Science news updated'))
      .catch((err) => {
        console.error('Submit Error:', err);
        alert('❌ Failed to update Science news');
      });
  };

  return (
    <div className="max-w-6xl mx-auto p-6">
      <h1 className="text-3xl font-bold text-center mb-8">🔬 Update Science News</h1>
