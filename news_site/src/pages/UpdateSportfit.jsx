...
export default function UpdateSportfit() {
  ...
  useEffect(() => {
    axios
      .get(`${import.meta.env.VITE_BACKEND_URL}/api/sportfit`)
      .then((res) => setFormData(Array.isArray(res.data) ? res.data : []))
      .catch((err) => console.error('Failed to load sportfit articles', err));
  }, []);
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post(`${import.meta.env.VITE_BACKEND_URL}/api/sportfit`, cleanedData)
      .then(() => alert('✅ Sportfit articles updated'))
      .catch((err) => {
        console.error('Submit Error:', err);
        alert('❌ Failed to update sportfit articles');
      });
  };

  return (
    <div className="max-w-6xl mx-auto p-6">
      <h1 className="text-3xl font-bold text-center mb-8">🏋️‍♂️ Manage Sportfit Articles</h1>
