...
export default function UpdateTech() {
  ...
  useEffect(() => {
    axios
      .get(`${import.meta.env.VITE_BACKEND_URL}/api/tech`)
      .then((res) => setFormData(Array.isArray(res.data) ? res.data : []))
      .catch((err) => console.error('Failed to load tech articles', err));
  }, []);
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post(`${import.meta.env.VITE_BACKEND_URL}/api/tech`, cleanedData)
      .then(() => alert('✅ Tech articles updated successfully!'))
      .catch((err) => {
        console.error('Submit Error:', err);
        alert('❌ Failed to update tech articles');
      });
  };

  return (
    <div className="max-w-6xl mx-auto p-6">
      <h1 className="text-3xl font-bold text-center mb-8">💻 Tech Articles Manager</h1>
