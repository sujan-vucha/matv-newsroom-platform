...
export default function UpdateViralNews() {
  ...
  useEffect(() => {
    axios
      .get(`${import.meta.env.VITE_BACKEND_URL}/api/viral-news`)
      .then((res) => setFormData(Array.isArray(res.data) ? res.data : []))
      .catch((err) => console.error('Failed to load viral news', err));
  }, []);
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post(`${import.meta.env.VITE_BACKEND_URL}/api/viral-news`, cleanedData)
      .then(() => alert('✅ Viral news updated successfully!'))
      .catch((err) => {
        console.error('Submit Error:', err);
        alert('❌ Failed to update viral news');
      });
  };

  return (
    <div className="max-w-6xl mx-auto p-6">
      <h1 className="text-3xl font-bold text-center mb-8">🔥 Viral News Manager</h1>
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  type="text"
                  placeholder="e.g., Trending, Politics"
                  className="w-full p-2 border rounded"
                  value={item.category}
              ...
              <div className="md:col-span-2">
                ...
                <textarea
                  rows={5}
                  placeholder="Write the viral news content..."
                  className="w-full p-2 border rounded"
                  value={item.content || ''}
